...
{
    if ($role === 'client')
        return '/Reservation-transport/client/dashboard.php';
    if ($role === 'transporter')
        return '/Reservation-transport/transporter/dashboard.php';
    if ($role === 'admin')
        return '/Reservation-transport/admin/dashboard.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action === 'update_profile') {
        ...
        if ($check->rowCount() > 0) {
            ...
            $upd = $pdo->prepare("UPDATE users SET name = ?, email = ?, phone = ?, region = ? WHERE id = ?");
            if ($upd->execute([$name, $email, $phone, $region, $user_id])) {
                $_SESSION['name'] = $name;
        ...
        <main class="main-content">
            ...
            <div class="page-header" style="max-width: 800px; margin: 0 auto 30px auto;">
                <div>
                    ...
                    <p style="color: #94a3b8; margin-top: 5px;">Gérez vos informations, la sécurité et vos préférences.
                    </p>
                </div>
                <a href="<?php echo $dashPath; ?>" class="btn-secondary" style="width: auto; padding: 10px 20px;"><i
                        class="fas fa-arrow-left"></i> Retour au tableau de bord</a>
            </div>
                            ...
                            <div class="form-row" style="margin-bottom: 25px;">
                                ...
                                <div class="form-group-dash">
                                    ...
                                    <input type="text" name="region"
                                        value="<?php echo htmlspecialchars($user['region'] ?? 'Algérie'); ?>"
                            ...
                            <div class="form-group-dash" style="margin-bottom: 25px;">
                                ...
                                <div style="position: relative; max-width: 400px;">
                                    ...
                                    <i class="fas fa-eye password-toggle"
                                        style="position: absolute; right: 8px; top: 50%; transform: translateY(-50%); cursor: pointer; color:#94a3b8; padding: 10px;"></i>
                                </div>
                            </div>
                ...
                <div class="settings-section danger-zone">
                    ...
                    <div class="settings-body">
                        <p style="color: #cbd5e1; font-size: 15px; margin-bottom: 25px; line-height: 1.6;">
                            <strong>Attention:</strong> La suppression de votre compte est irréversible. Toutes vos
                            données personnelles, historique de réservations, et véhicules seront définitivement effacés
                            de nos serveurs. Vous serez immédiatement déconnecté.
                        </p>
                        ...
                        <form id="delete-account-form" method="POST">
                            ...
                            <div class="form-row" style="align-items: flex-end;">
                                <div class="form-group-dash" style="margin: 0; flex: 1; max-width: 400px;">
                                    ...
                                    <div style="position: relative;">
                                        <input type="password" name="verify_password" id="delete-password" required
                                            style="width: 100%; border-color: rgba(239,68,68,0.5); background: rgba(0,0,0,0.2); padding-right:40px;">
                                        <i class="fas fa-eye password-toggle"
                                            style="position: absolute; right: 8px; top: 50%; transform: translateY(-50%); cursor: pointer; color:#94a3b8; padding: 10px;"></i>
                                    </div>
                                </div>
                                <div style="flex-shrink: 0;">
                                    <button type="button" id="btn-delete-account" class="btn-primary"
                                        style="background: #ef4444; border-color: #ef4444; width: auto; padding: 12px 25px;">
